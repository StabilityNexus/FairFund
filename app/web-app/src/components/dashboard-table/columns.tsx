        ...
        cell: ({ row }) => {
            ...
            return (
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger>
                        <Badge variant="outline">{fundingTokenSymbol as React.ReactNode}</Badge>
                        </TooltipTrigger>
                        <TooltipContent>
                            <div className="flex flex-col gap-1">
                                <p className="text-sm">Token Address: {fundingTokenAddress as React.ReactNode}</p>
                            </div>
                        </TooltipContent>
                    </Tooltip>
                </TooltipProvider>
        ...
        cell: ({ row }) => {
            ...
            return (
                <TooltipProvider>
                    <Tooltip>
                        <TooltipTrigger>
                        <Badge variant="outline">{votingTokenSymbol as React.ReactNode}</Badge>
                        </TooltipTrigger>
                        <TooltipContent>
                            <div className="flex flex-col gap-1">
                                <p className="text-sm">Token Address: {votingTokenAddress as React.ReactNode}</p>
                            </div>
                        </TooltipContent>
                    </Tooltip>
                </TooltipProvider>
